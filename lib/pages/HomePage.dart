                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () => getBuyerId(isLiked, image, description,
                                date, name, price, category, ownerId),
                            child: Icon(
                              isLiked ? Icons.star : Icons.star_border_outlined,
                              color: isLiked ? Colors.amber : Colors.amber[200],
                              size: buttonSize,
                            ),
                          ),
                        ),
...
Future getBuyerId(bool isLiked, String image, String description, String date,
  ...
  if (isLiked == false) {
    saveToFavoriteDatabase(
        image, buyerId, description, date, name, price, category, ownerId);
  }
}

saveToFavoriteDatabase(String image, String buyerId, String description,
    String date, String name, String price, String category, String ownerId) {
  ...
  Fluttertoast.showToast(
      msg: "Item was added to favorites",
